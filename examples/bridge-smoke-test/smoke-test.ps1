...
Assert-True ($identity.environment -eq "dev") "Unexpected environment."
...
Write-Host ""
Write-Host "Bridge smoke test passed (local-only mode — no MCP governance configured)." -ForegroundColor Green