...
> **local-only** mode — realization is not gated through MCP governance. The
> test validates contract shape regardless of mode.
...
the first POST /realize returns ACCEPT with digest, message, and realized_at
